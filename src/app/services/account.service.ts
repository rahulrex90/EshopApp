 ...
 * by doing this other classes are allowed to access the functionality of our account
 *  service class through a feature called dependency injection.
*/
...
@Injectable({
 ...
 export class AccountService {
    ...
    private baseUrlLogin = 'https://localhost:44371/api/account/login';

    private baseUrlRegister = 'https://localhost:44371//api/account/register';
